...
const collection = collect(await request("https://api.argentinadatos.com/v1/cotizaciones/dolares"))

const candlesticksPorCasa = collection
    .groupBy('casa')
    .map((dolares) => {
...
process.stdout.write(
    JSON.stringify(candlesticksPorCasa)
);
